...
abstract class AbstractConeCallConflictResolver(
    ...
    private val samResolver = FirSamResolverImpl(inferenceComponents.session, ScopeSession())
            ...
            if (typeForCallableReference != null) {
                ...
                call.argumentMapping?.mapTo(this) { (_, parameter) ->
                    ...
                    if (!call.usesSAM) {
                        ...
                        val functionType = samResolver.getSamInfoForPossibleSamType(argumentType)?.second
